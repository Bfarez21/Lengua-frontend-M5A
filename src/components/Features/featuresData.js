...
const featuresData = [
    {
        id: 1,
        icon: (
            <ConnectWithoutContactIcon style={{ fontSize: 40 }} />
        ),
        title: "Inclusión social",
        paragraph:
            "Facilita la participación activa de personas sordas en actividades y espacios comunitarios, eliminando barreras de comunicación y promoviendo la igualdad.",
    },
    {
        id: 1,
        icon: (
        ...
        paragraph:
            "Garantiza que los estudiantes sordos tengan acceso a una educación de calidad mediante herramientas y métodos adaptados a sus necesidades.",
    },
    {
        id: 1,
        icon: (
            <WorkspacesIcon style={{ fontSize: 40 }} />
        ),
        title: "Inclusión laboral",
        paragraph:
            "Promueve la integración de personas sordas en el ámbito profesional, asegurando condiciones de trabajo accesibles y equitativas.",
    },
    {
        id: 1,
        icon: (
        ...
        title: "Mejora de la comunicación entre personas sordas y oyentes",
        paragraph:
            "Fomenta una interacción efectiva y comprensible entre ambos grupos, fortaleciendo las relaciones interpersonales y el entendimiento mutuo.",
    },
    {
        id: 1,
        icon: (
            <Diversity2Icon style={{ fontSize: 40 }} />
        ),
        title: "Usabilidad en diversos entornos",
        paragraph:
            "Permite que las soluciones diseñadas sean efectivas y accesibles en diferentes contextos, como escuelas, oficinas, atención al cliente, y espacios públicos.",
    },
    /*{
        id: 1,
        icon: (
